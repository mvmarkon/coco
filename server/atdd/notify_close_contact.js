...
//     // let validCloseContactData = {
// 	// 	notify_to: [],
//     //       notified: false,
//     //       notificationName:"Contagio",
...
//   test('Como cliente(app) quiero enviar una peticion POST y notificar a usuarios con los que estuve en contacto estrecho', ({ given, and, when, then }) => {
// 		given('Que existe el usuario con el que quiero notificar el posible covid', async () => {
